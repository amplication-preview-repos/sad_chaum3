...
@InputType()
class InterviewCreateNestedManyWithoutCompaniesInput {
...
export { InterviewCreateNestedManyWithoutCompaniesInput as InterviewCreateNestedManyWithoutCompaniesInput };
